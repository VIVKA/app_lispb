        ...
        <div id="app">
            ...
            <div v-show="currentstep == 1">
                ...
                <section class="container my-5" id="result-container">
                    <div class="row justify-content-center">
                        Заявление о приеме в 1 класс на обучение по дополнительной предпрофессиональной программе в области
                        музыкального искусства (срок обучения согласно выбранной программе)
                        )
                    </div>
                    <p>Укажите цифрами от 1 до 3 в порядке приоритета (1 - наивысший приоритет, 3 - наименьший приоритет) не более трех
                        направлений</p>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>Фортепиано</td>
                            <td>
                                <input type="radio" class="btn-check" name="piano" id="btnradio0" autocomplete="off" checked>
                        ...
                        <tr>
                            ...
                            <td>Скрипка</td>
                            <td>
                                <input type="radio" class="btn-check" name="violin" id="btnradio4" autocomplete="off" checked>
                        ...
                        <tr>
                            <td>Альт</td>
                            <td>
                                <input type="radio" class="btn-check" name="alt" id="btnradio9" autocomplete="off" checked>
                        ...
                        <tr>
                            <td>Виолончель</td>
                            <td>
                                <input type="radio" class="btn-check" name="violoncello" id="btnradio14" autocomplete="off" checked>
                                <label class="btn btn-outline-primary" for="btnradio14">0</label>
                                <input type="radio" class="btn-check" name="violoncello" id="btnradio15" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio15">1</label>
                                <input type="radio" class="btn-check" name="violoncello" id="btnradio16" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio16">2</label>
                                <input type="radio" class="btn-check" name="violoncello" id="btnradio17" autocomplete="off">
                        ...
                        <tr>
                            <td>Контрабас</td>
                            <td>
                                <input type="radio" class="btn-check" name="doublebass" id="btnradio18" autocomplete="off" checked>
                                <label class="btn btn-outline-primary" for="btnradio18">0</label>
                                <input type="radio" class="btn-check" name="doublebass" id="btnradio19" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio19">1</label>
                                <input type="radio" class="btn-check" name="doublebass" id="btnradio20" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio20">2</label>
                                <input type="radio" class="btn-check" name="doublebass" id="btnradio21" autocomplete="off">
                        ...
                        <tr>
                            <td>Арфа</td>
                            <td>
                                <input type="radio" class="btn-check" name="harp" id="btnradio22" autocomplete="off" checked>
                        ...
                        <tr>
                            ...
                            <td>Флейта</td>
                            <td>
                                <input type="radio" class="btn-check" name="flute" id="btnradio26" autocomplete="off" checked>
                        ...
                        <tr>
                            <td>Гобой</td>
                            <td>
                                <input type="radio" class="btn-check" name="oboe" id="btnradio30" autocomplete="off" checked>
                        ...
                        <tr>
                            <td>Кларнет</td>
                            <td>
                                <input type="radio" class="btn-check" name="clarinet" id="btnradio34" autocomplete="off" checked>
                                <label class="btn btn-outline-primary" for="btnradio34">0</label>
                                <input type="radio" class="btn-check" name="clarinet" id="btnradio35" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio35">1</label>
                                <input type="radio" class="btn-check" name="clarinet" id="btnradio36" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio36">2</label>
                                <input type="radio" class="btn-check" name="clarinet" id="btnradio37" autocomplete="off">
                        ...
                        <tr>
                            <td>Труба</td>
                            <td>
                                <input type="radio" class="btn-check" name="trumpet" id="btnradio38" autocomplete="off" checked>
                        ...
                        <tr>
                            <td>Тромбон</td>
                            <td>
                                <input type="radio" class="btn-check" name="trombone" id="btnradio46" autocomplete="off" checked>
                                <label class="btn btn-outline-primary" for="btnradio46">0</label>
                                <input type="radio" class="btn-check" name="trombone" id="btnradio47" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio47">1</label>
                                <input type="radio" class="btn-check" name="trombone" id="btnradio48" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio48">2</label>
                                <input type="radio" class="btn-check" name="trombone" id="btnradio49" autocomplete="off">
                        ...
                        <tr>
                            <td>Валторна</td>
                            <td>
                                <input type="radio" class="btn-check" name="frenchhorn" id="btnradio50" autocomplete="off" checked>
                                <label class="btn btn-outline-primary" for="btnradio50">0</label>
                                <input type="radio" class="btn-check" name="frenchhorn" id="btnradio51" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio51">1</label>
                                <input type="radio" class="btn-check" name="frenchhorn" id="btnradio52" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio52">2</label>
                                <input type="radio" class="btn-check" name="frenchhorn" id="btnradio53" autocomplete="off">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="radio" class="btn-check" name="drum" id="btnradio58" autocomplete="off" checked>
                        ...
                        <tr>
                            ...
                            <td>Баян</td>
                            <td>
                                <input type="radio" class="btn-check" name="bayan" id="btnradio62" autocomplete="off" checked>
                        ...
                        <tr>
                            <td>Аккордеон</td>
                            <td>
                                <input type="radio" class="btn-check" name="accordion" id="btnradio66" autocomplete="off" checked>
                                <label class="btn btn-outline-primary" for="btnradio66">0</label>
                                <input type="radio" class="btn-check" name="accordion" id="btnradio67" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio67">1</label>
                                <input type="radio" class="btn-check" name="accordion" id="btnradio68" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio68">2</label>
                                <input type="radio" class="btn-check" name="accordion" id="btnradio69" autocomplete="off">
                        ...
                        <tr>
                            <td>Домра</td>
                            <td>
                                <input type="radio" class="btn-check" name="domra" id="btnradio70" autocomplete="off" checked>
                        ...
                        <tr>
                            <td>Балалайка</td>
                            <td>
                                <input type="radio" class="btn-check" name="balalaika" id="btnradio74" autocomplete="off" checked>
                                <label class="btn btn-outline-primary" for="btnradio74">0</label>
                                <input type="radio" class="btn-check" name="balalaika" id="btnradio75" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio75">1</label>
                                <input type="radio" class="btn-check" name="balalaika" id="btnradio76" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio76">2</label>
                                <input type="radio" class="btn-check" name="balalaika" id="btnradio77" autocomplete="off">
                        ...
                        <tr>
                            <td>Гусли</td>
                            <td>
                                <input type="radio" class="btn-check" name="psaltery" id="btnradio78" autocomplete="off" checked>
                                <label class="btn btn-outline-primary" for="btnradio78">0</label>
                                <input type="radio" class="btn-check" name="psaltery" id="btnradio79" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio79">1</label>
                                <input type="radio" class="btn-check" name="psaltery" id="btnradio80" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio80">2</label>
                                <input type="radio" class="btn-check" name="psaltery" id="btnradio81" autocomplete="off">
                        ...
                        <tr>
                            <td>Гитара</td>
                            <td>
                                <input type="radio" class="btn-check" name="guitar" id="btnradio82" autocomplete="off" checked>
                        ...
                        <tr>
                            ...
                            <td>Саксофон</td>
                            <td>
                                <input type="radio" class="btn-check" name="saxophone" id="btnradio86" autocomplete="off" checked>
                                <label class="btn btn-outline-primary" for="btnradio86">0</label>
                                <input type="radio" class="btn-check" name="saxophone" id="btnradio87" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio87">1</label>
                                <input type="radio" class="btn-check" name="saxophone" id="btnradio88" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio88">2</label>
                                <input type="radio" class="btn-check" name="saxophone" id="btnradio89" autocomplete="off">
                        ...
                        <tr>
                            <td>Тромбон</td>
                            <td>
                                <input type="radio" class="btn-check" name="trombone2" id="btnradio90" autocomplete="off" checked>
                                <label class="btn btn-outline-primary" for="btnradio90">0</label>
                                <input type="radio" class="btn-check" name="trombone2" id="btnradio91" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio91">1</label>
                                <input type="radio" class="btn-check" name="trombone2" id="btnradio92" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio92">2</label>
                                <input type="radio" class="btn-check" name="trombone2" id="btnradio93" autocomplete="off">
                        ...
                        <tr>
                            <td>Бас-гитара</td>
                            <td>
                                <input type="radio" class="btn-check" name="guitar2" id="btnradio98" autocomplete="off" checked>
                                ...
                                <input type="radio" class="btn-check" name="guitar2" id="btnradio100" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio100">2</label>
                                <input type="radio" class="btn-check" name="guitar2" id="btnradio101" autocomplete="off">
                        ...
                        <tr>
                            ...
                            <td>----</td>
                            <td>
                                <input type="radio" class="btn-check" name="chorus" id="btnradio106" autocomplete="off" checked>
                        ...
                        <tr>
                            ...
                            <td>----</td>
                            <td>
                                <input type="radio" class="btn-check" name="folklore" id="btnradio110" autocomplete="off" checked>
                                <label class="btn btn-outline-primary" for="btnradio110">0</label>
                                <input type="radio" class="btn-check" name="folklore" id="btnradio111" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio111">1</label>
                                <input type="radio" class="btn-check" name="folklore" id="btnradio112" autocomplete="off">
                                <label class="btn btn-outline-primary" for="btnradio112">2</label>
                                <input type="radio" class="btn-check" name="folklore" id="btnradio113" autocomplete="off">
            ...
            <div v-show="currentstep == 2">
                ...
                <form>
                    ...
                    <div class="row">
                        <div class="col-md-8"
                        <p>в 1 класс на обучение в СПБ ГБНОУ “Лицей искусств “Санкт-Петербург” и провести индивидуальный отбор по
                            дополнительным предпрофессиональным программам в области музыкального искусства (от одной до трех)</p>
                    </div>
            </div>
            <div class="row">
                <div class="col-md-8">
                ...
                <div class="col-md-8">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                        <label class="form-check-label" for="flexCheckDefault">
                            С <a href="#">Согласием на обработку персональных данных ребенка</a>, разрешенных  родителем (законным представителем) ребенкадля распространения (для размещения результатов индивидуального отбора на сайте учреждения) ознакомлен(а)
                        </label>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                        <label class="form-check-label" for="flexCheckDefault">
                            С <a href="#">уставом учреждения</a>, со <a href="#">сведениями о дате предоставления и регистрационном номере лицензии на осуществление образовательной деятельности</a> ознакомлен(а)
                        </label>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                        <label class="form-check-label" for="flexCheckDefault">
                            С <a href="#">Правилами приема в учреждение</a> на обучение по дополнительным предпрофессиональным программам в области искусств ознакомлен(а)
                        </label>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                        <label class="form-check-label" for="flexCheckDefault">
                            С <a href="#">образовательными программами</a>, с <a href="#">правами и обязанностями обучающихся</a> ознакомлен(а)
                        </label>
                    </div>
                </div>
                <div class="col-md-8">
                ...
                <div class="col-md-8">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
                        <label class="form-check-label" for="flexCheckDefault">
                            Даю согласие на процедуру индивидуального отбора в отношении моего ребенка в соответствии с <a href="#">Правилами приема в учреждение</a>
                        </label>
                    </div>
                </div>
            </div>
